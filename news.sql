...
-- Dumping structure for table news.advertisements
...
-- Dumping data for table news.categories: ~17 rows (approximately)
...
-- Dumping structure for table news.countries
...
-- Dumping data for table news.countries: ~242 rows (approximately)
...
-- Dumping structure for table news.languages
...
-- Dumping data for table news.languages: ~3 rows (approximately)
...
-- Dumping structure for table news.likes
...
-- Dumping data for table news.likes: ~0 rows (approximately)

-- Dumping structure for table news.media
...
-- Dumping data for table news.migrations: ~9 rows (approximately)
...
INSERT INTO `news` (`id`, `news_lang`, `news_title`, `news_provider`, `news_description`, `news_medias`, `news_posted_by`, `category`, `tag`, `status`, `is_fetured`, `is_rss`, `rss_url`, `rss_media`, `rss_media_thumbnail`, `viewed`, `created_at`, `updated_at`, `deleted_at`) VALUES
	(1, 'EN', 'Judul 1', 'A', 'sgdfhgj<p></p>', '2|1', 'abc', '14', '2|3', 1, 0, 0, NULL, NULL, NULL, 0, '2023-05-23 16:39:48', '2023-05-23 16:39:48', NULL),
	...
	(4, 'EN', 'Judul 2', 'A', '<p></p><p style="text-align: justify; ">MANGGAR - Ketua DPRD Beltim Fezzi Uktolseja, SE, MM menghadiri acara Apel Gelar Pasukan Operasi Patuh Menumbing Tahun 2022 yang dilaksanakan di Lapangan Upacara Mapolres Belitung Timur, Senin (13/6).</p><p style="text-align: justify; ">Apel dipimpin oleh Kapolres Beltim serta turut dihadiri Forkopimda, Personil Dishub, Personil Satpol-PP, Basarnas, BPBD, Dinsos, Jasa Raharja, dan Polsek se-Beltim.</p><p style="text-align: justify; ">Pelaksanaan Operasi Patuh Menumbing Tahun 2022, dijadwalkan berlangsung mulai hari ini 13 Juni sampai dengan 26 Juni 2022.</p><p></p><p></p><p></p>', '2|1', 'Judul 2', NULL, NULL, 1, 0, 0, NULL, NULL, NULL, 0, '2023-05-24 12:28:05', '2023-05-24 12:28:05', NULL);
...
-- Dumping data for table news.pages: ~0 rows (approximately)
...
-- Dumping structure for table news.pullings
CREATE TABLE IF NOT EXISTS `pullings` (
...
-- Dumping structure for table news.rss_links
...
-- Dumping data for table news.rss_links: ~5 rows (approximately)
...
-- Dumping structure for table news.settings
...
-- Dumping data for table news.settings: ~0 rows (approximately)

-- Dumping structure for table news.tags
...
-- Dumping data for table news.tags: ~5 rows (approximately)
...
-- Dumping structure for table news.timezones
...
-- Dumping data for table news.timezones: ~416 rows (approximately)
